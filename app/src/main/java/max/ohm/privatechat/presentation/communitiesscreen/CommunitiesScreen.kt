...
fun CommunitiesScreen (navHostController: NavHostController) {
    ...
    val sampleCommunities = listOf(
        Communities(R.drawable.disha_patani, "Bollywood Actress", "346 members"),
        Communities(R.drawable.img, "Idea Group", "654 members"),
        Communities(R.drawable.tripti_dimri, "New Actress", "536 members")
    )
    ...
    Scaffold(topBar= {
        ...
        Column(modifier= Modifier.padding(it)) {
            Button(onClick = { }, colors = ButtonDefaults.buttonColors(
                ...
                // Button text
                Text(text = "Start a new Commmunities", fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }
            Spacer(modifier = Modifier.height(8.dp))

            Text(text = "Your Communities", fontSize = 20.sp, fontWeight = FontWeight.Bold,
